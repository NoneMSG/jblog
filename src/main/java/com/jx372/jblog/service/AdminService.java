...
import com.jx372.jblog.repository.AdminDao;
import com.jx372.jblog.vo.AdminVo;
import com.jx372.jblog.vo.BlogVo;

@Service
public class AdminService {
	private static final String SAVE_PATH = "/jbloguploads";
	...
	public List<AdminVo> getCategoryList(Long userNo) {
		return adminDao.getCategoryList(userNo);
	}
	
	public void getUpdateBlogInfo(BlogVo blogVo) {
		adminDao.getBlogInfo(blogVo);
	}
	
	public BlogVo getBlogInfo(Long userNo) {
		return adminDao.getBlogInfo(userNo);
